...
namespace GPUInstancer
{
    ...
    public class GPUInstancerDefines
    {
        ...
        private static Assembly _billboardExtensionAssembly;
        ...
        static GPUInstancerDefines()
        {
            ...
            List<string> defineList = new List<string>(PlayerSettings.GetScriptingDefineSymbols(UnityEditor.Build.NamedBuildTarget.FromBuildTargetGroup(EditorUserBuildSettings.selectedBuildTargetGroup)).Split(';'));
#else
...
#if UNITY_6000_0_OR_NEWER
                PlayerSettings.SetScriptingDefineSymbols(UnityEditor.Build.NamedBuildTarget.FromBuildTargetGroup(EditorUserBuildSettings.selectedBuildTargetGroup), defines);
#else
        ...
        static void GetBillboardExtensions()
        {
            try
            {
                ...
                if (_billboardExtensionAssembly == null)
                    _billboardExtensionAssembly = Assembly.GetAssembly(_billboardExtensionType);

                IEnumerable<Type> types = _billboardExtensionAssembly.GetTypes()
