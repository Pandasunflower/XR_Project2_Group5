...
namespace GPUInstancer
{
    ...
    {
        public static readonly string GPUI_VERSION = "GPU Instancer v1.8.5";
        public static readonly float GPUI_VERSION_NO = 1.85f;
        ...
        {
            GameObject[] prefabInstances = GPUInstancerUtility.FindObjectsOfType<GameObject>();
        ...
        private static void AddPrefabObjectsToList(GameObject go, List<GameObject> prefabList)
        {
            ...
            if (prefabType == PrefabAssetType.Regular || prefabType == PrefabAssetType.Variant)
            {
                ...
                if (prefabType == PrefabAssetType.Variant)
                {
                    ...
                    if (newPrefabObject != null && PrefabUtility.GetPrefabAssetType(newPrefabObject) != PrefabAssetType.Model)
                    {
        ...
        [MenuItem("Assets/GPU Instancer/Mark Shader Addressable", validate = false, priority = 2002)]
        ...
        [MenuItem("Assets/GPU Instancer/Mark Shader Addressable", validate = true, priority = 2002)]
...
#if GPUI_ADDRESSABLES
            gPUInstancerSettings.loadFromAddressables = EditorGUILayout.Toggle("Load From Addressables", gPUInstancerSettings.loadFromAddressables);
#endif
