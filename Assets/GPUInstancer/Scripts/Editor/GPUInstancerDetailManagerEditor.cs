    ...
    public class GPUInstancerDetailManagerEditor : GPUInstancerManagerEditor
    {
        ...
        public override void DrawGlobalValuesContents()
        {
            ...
            if (_detailManager.terrainSettings.healthyDryNoiseTexture == null)
                _detailManager.terrainSettings.healthyDryNoiseTexture = GPUInstancerUtility.LoadResource<Texture2D>(GPUInstancerConstants.NOISE_TEXTURES_PATH + GPUInstancerConstants.DEFAULT_HEALTHY_DRY_NOISE);
            ...
            if (_detailManager.terrainSettings.windWaveNormalTexture == null)
                _detailManager.terrainSettings.windWaveNormalTexture = GPUInstancerUtility.LoadResource<Texture2D>(GPUInstancerConstants.NOISE_TEXTURES_PATH + GPUInstancerConstants.DEFAULT_WIND_WAVE_NOISE);
