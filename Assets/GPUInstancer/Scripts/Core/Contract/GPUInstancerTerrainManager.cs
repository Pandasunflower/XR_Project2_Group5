...
namespace GPUInstancer
{
    public abstract class GPUInstancerTerrainManager : GPUInstancerManager
    {
        ...
        private GPUInstancerTerrainSettings GenerateTerrainSettings(Terrain terrain, GameObject gameObject)
        {
            ...
            terrainSettings.healthyDryNoiseTexture = GPUInstancerUtility.LoadResource<Texture2D>(GPUInstancerConstants.NOISE_TEXTURES_PATH + GPUInstancerConstants.DEFAULT_HEALTHY_DRY_NOISE);
            terrainSettings.windWaveNormalTexture = GPUInstancerUtility.LoadResource<Texture2D>(GPUInstancerConstants.NOISE_TEXTURES_PATH + GPUInstancerConstants.DEFAULT_WIND_WAVE_NOISE);
