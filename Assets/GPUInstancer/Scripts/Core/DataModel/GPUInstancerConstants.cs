...
namespace GPUInstancer
{
    ...
    public static class GPUInstancerConstants
    {
        ...
        public static void SetupComputeSetDataPartial()
        {
            ...
            {
                computeBufferSetDataPartial = GPUInstancerUtility.LoadResource<ComputeShader>(COMPUTE_SET_DATA_PARTIAL_RESOURCE_PATH);
                if (computeBufferSetDataPartial != null)
                {
        ...
        public static void SetupComputeTextureUtils()
        {
            ...
            {
                computeTextureUtils = GPUInstancerUtility.LoadResource<ComputeShader>(COMPUTE_TEXTURE_UTILS_PATH);
        ...
        public static void SetupComputeRuntimeModification()
        {
            ...
            {
                computeRuntimeModification = GPUInstancerUtility.LoadResource<ComputeShader>(COMPUTE_RUNTIME_MODIFICATION_RESOURCE_PATH);
