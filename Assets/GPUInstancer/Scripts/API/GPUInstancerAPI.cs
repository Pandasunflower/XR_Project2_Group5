...
namespace GPUInstancer
{
    public static class GPUInstancerAPI
    {
        ...
        /// <summary>
        /// Can be used to change the renderingLayerMask for a prototype
        /// </summary>
        /// <param name="manager">GPUI Manager</param>
        /// <param name="prototype">GPUI Prototype</param>
        /// <param name="renderingLayerMask">Determines which rendering layer this renderer lives on</param>
        /// <param name="lodLevel">LOD level</param>
        /// <param name="rendererIndex">Renderer index on the LOD level</param>
        public static void SetRenderingLayerMask(GPUInstancerManager manager, GPUInstancerPrototype prototype, uint renderingLayerMask, int lodLevel = -1, int rendererIndex = -1)
        {
            GPUInstancerUtility.SetRenderingLayerMask(manager.GetRuntimeData(prototype), renderingLayerMask, lodLevel, rendererIndex);
        }
