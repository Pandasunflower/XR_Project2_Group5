...
namespace GPUInstancer
{
    public class TerrainGenerator : MonoBehaviour
    {
        ...
        private void SwitchCameras()
        {
            ...
            var managers = GPUInstancerUtility.FindObjectsOfType<GPUInstancerDetailManager>();
            foreach (var manager in managers)
            {
                GPUInstancerAPI.SetCamera(manager, isCurrentCameraFixed
        ...
        private void GenerateTerrain()
        {
            ...
            terrainLayers[0].diffuseTexture = groundTexture;
            ...
            terrainArray[terrainCounter] = InitializeTerrainObject(terrainPosition, terrainSize, terrainSize / 2f, 16, 16, terrainLayers, detailPrototypes);
        ...
        private Terrain InitializeTerrainObject(Vector3 position, int terrainSize, float terrainHeight, int baseTextureResolution = 16, int detailResolutionPerPatch = 16, TerrainLayer[] terrainLayers = null, DetailPrototype[] detailPrototypes = null)
        {
            GameObject terrainGameObject = new GameObject("GeneratedTerrain");
...
#endif
            TerrainData terrainData = CreateTerrainData(terrainSize, terrainHeight, baseTextureResolution, detailResolutionPerPatch, terrainLayers, detailPrototypes);
        ...
        private TerrainData CreateTerrainData(int terrainSize, float terrainHeight, int baseTextureResolution = 16, int detailResolutionPerPatch = 16, TerrainLayer[] terrainLayers = null, DetailPrototype[] detailPrototypes = null)
        {
