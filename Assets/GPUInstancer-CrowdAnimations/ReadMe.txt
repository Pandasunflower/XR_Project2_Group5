GPU Instancer - Crowd Animations v1.2.0
Copyright ©2019-25 GurBu Technologies
---------------------------------
...
IMPORTANT: Requires GPU Instancer v1.8.5 or later

v1.2.0

Fixed: Warning in Unity 6: Adding null Transform to TransformAccessArray will result in degraded performance.
Fixed: Resolved an animation weight calculation issue during transitions when using the Mecanim Animator workflow.
