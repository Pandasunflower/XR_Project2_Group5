    ...
    public class GPUICrowdManagerEditor : GPUInstancerPrefabManagerEditor
    {
        ...
        public static void AddPickerObjectCrowd(GPUICrowdManager _crowdManager, UnityEngine.Object pickerObject, GPUInstancerPrototype overridePrototype = null)
        {
            ...
            if (prefabScript.prefabPrototype != null)
            {
                ...
                GPUICrowdPrefab[] scenePrefabInstances = GPUInstancerUtility.FindObjectsOfType<GPUICrowdPrefab>();
        ...
        public override void DrawGPUInstancerPrototypeBeginningInfo(GPUInstancerPrototype selectedPrototype)
        {
            ...
            if (hasBakedData)
            {
                ...
                if (prototype.animationData.animationTexture != null && hasAnimator && prefabAnimator.hasTransformHierarchy)
                {
                    ...
                    if (prototype.animationData.optimizeGameObjects && !prototype.animationData.useCrowdAnimator)
                    {
                    ...
                    if (EditorGUI.EndChangeCheck() && !prototype.animationData.optimizeGameObjects && prototype.animationData.applyBoneUpdates)
                        prototype.animationData.applyBoneUpdates = false;
                    if (prototype.animationData.useCrowdAnimator && !prototype.animationData.optimizeGameObjects)
                        EditorGUILayout.HelpBox("Bone GameObjects will not be removed, however their transforms will also not be updated. Use the \"Enable Bone Updates\" option to select the bones transforms that needs to be updated.", MessageType.Warning);
                }
                ...
                if (prototype.animationData.useCrowdAnimator)
                {
                    ...
                    if(EditorGUI.EndChangeCheck() && !prototype.animationData.optimizeGameObjects && prototype.animationData.applyBoneUpdates)
                        prototype.animationData.optimizeGameObjects = true;
