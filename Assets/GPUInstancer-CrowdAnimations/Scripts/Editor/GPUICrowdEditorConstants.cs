...
namespace GPUInstancer.CrowdAnimations
{
    ...
    {
        public static readonly string GPUI_CA_VERSION = "GPUI-Crowd Animations v1.2.0";
        public static readonly float GPUI_CA_VERSION_NO = 1.20f;
