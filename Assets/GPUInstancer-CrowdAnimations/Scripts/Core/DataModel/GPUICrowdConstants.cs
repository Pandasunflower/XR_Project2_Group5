...
namespace GPUInstancer.CrowdAnimations
{
    public static class GPUICrowdConstants
    {
        ...
        public static readonly string SHADER_GPUI_CROWD_URP_LIT_SPECULAR = "GPUInstancer/CrowdAnimations/Universal Render Pipeline/Crowd_Animations_LIT_Specular_SG";
#else
